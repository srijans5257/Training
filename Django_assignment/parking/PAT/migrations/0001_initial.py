...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.IntegerField(verbose_name=[django.core.validators.MinValueValidator(0)])),
                ('type', models.CharField(choices=[('tw', 'tw'), ('fw', 'fw')], max_length=10)),
                ('vehicle_number', models.CharField(max_length=20)),
                ('Lot', models.IntegerField(verbose_name=[django.core.validators.MinValueValidator(0)])),
                ('Fee', models.FloatField(verbose_name=[django.core.validators.MinValueValidator(0.0)])),
                ('In', models.DateTimeField()),
                ('Out', models.DateTimeField()),
                ('parking_space', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='PAT.parkingspace')),
            ],
        ),
        migrations.CreateModel(
            name='User',
